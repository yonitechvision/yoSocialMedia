"""
Django settings for SocialMediaRobust project.
...
ROOT_URLCONF = 'SocialMediaRobust.urls'
...
WSGI_APPLICATION = 'SocialMediaRobust.wsgi.application'
...
# REST framework settings (including JWT authentication and pagination)
REST_FRAMEWORK = {
...
#Optional: If using Redis for channels (recommended for production)
CHANNEL_LAYERS = {
    'default': {
